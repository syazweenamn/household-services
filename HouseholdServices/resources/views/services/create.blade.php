    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">New Service</h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('servicecategory_id') is-invalid @enderror" id="servicecategory_id" name="servicecategory_id" required>
                                    <option selected disabled>Select Service Category</option>
                                    @foreach ($servicecategories as $servicecategory)
                                        <option value="{{ $servicecategory->id }}" @selected(old('servicecategory_id') == $servicecategory->id)>{{ $servicecategory->servicecategory_name }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                value="{{ old('service_description') }}" required>
