    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Edit Worker</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('workers.update', ['worker' => $worker->id]) }}" method="post">
                    @method('put')
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('worker_name') is-invalid @enderror" id="worker_name" name="worker_name" 
                                value="{{ old('worker_name', $worker->worker_name) }}" required>
